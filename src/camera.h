...
struct IsometricCamera {
    ...
    void handle_input(float dt) {
        ...
        if (raylib::IsKeyDown(raylib::KEY_W) || raylib::IsKeyDown(raylib::KEY_UP)) {
            move_z -= pan_speed * dt;
        }
        if (raylib::IsKeyDown(raylib::KEY_S) || raylib::IsKeyDown(raylib::KEY_DOWN)) {
            move_z += pan_speed * dt;
        }
        if (raylib::IsKeyDown(raylib::KEY_A) || raylib::IsKeyDown(raylib::KEY_LEFT)) {
            move_x -= pan_speed * dt;
        }
        if (raylib::IsKeyDown(raylib::KEY_D) || raylib::IsKeyDown(raylib::KEY_RIGHT)) {
            move_x += pan_speed * dt;
        }
